...
REPORT_FILE = "product_definitions.json"
...
def main():
    ...
    with open('products_count_by_tenant.txt', 'w') as f:
    ...
    with open('product_type_count_by_tenant.txt', 'w') as f:
    ...
    print(f"Products Count by Tenant Report is saved to products_count_by_tenant.txt")
    print(f"Product Type Count by Tenant Report is saved to product_type_count_by_tenant.txt")
